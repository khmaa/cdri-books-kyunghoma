...
| Phase | 내용                                                        | 상태      |
| ----- | ----------------------------------------------------------- | --------- |
| 0     | 프로젝트 부트스트랩 (Vite + TS + ESLint + Prettier + Husky) | ✅ 완료   |
| 1     | 라우팅 + 레이아웃 + 디자인 토큰 + 아이콘 컴포넌트           | ✅ 완료   |
| 2     | Kakao API 클라이언트 + 기본 검색                            | 🚧 미구현 |
| 3     | 상세보기 Accordion                                          | 🚧 미구현 |
| 4     | 상세 검색 모달                                              | 🚧 미구현 |
| 5     | 최근 검색어                                                 | 🚧 미구현 |
| 6     | 찜하기 + 내가 찜한 책 페이지                                | 🚧 미구현 |
| 7     | 무한 스크롤 + Prefetch                                      | 🚧 미구현 |
| 8     | 디테일 / 폴리시                                             | 🚧 미구현 |
